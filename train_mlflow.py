...
# ==========================================
# 0. KONFIGURASI MLFLOW LOKAL (FILE-BASED)
# ==========================================
# Simpan log di Drive C: agar tidak diganggu oleh Google Drive / desktop.ini
# Anda bisa mengubah "C:/MLflow_Projects" ke folder manapun di luar drive G:
mlflow.set_tracking_uri("C:\Users\LABOR-UNAMA\Downloads\Spam_Email_Detection")
...
if __name__ == "__main__":
    ...
    print("🚀 Memulai proses Training & MLflow Tracking...")
    ...
    with mlflow.start_run(run_name="ImbPipeline_TFIDF_SMOTE_LogReg"):
        ...
        # Log konfigurasi/parameter ke MLflow
        ...
        # Log keseluruhan model ke MLflow & Simpan lokal
        mlflow.sklearn.log_model(sk_model=pipeline, artifact_path="spam_email_pipeline")
        
        # CUKUP SIMPAN PIPELINE SAJA (TF-IDF sudah ada di dalamnya)
        ...
        print("💾 Model tersimpan sebagai 'spam_model_pipeline.pkl'")
        
        # Teks panduan UI sudah disesuaikan dengan direktori lokal baru Anda
        print("💡 Cek UI MLflow dengan menjalankan terminal:")
        print("   mlflow ui --backend-store-uri file:///C:/MLflow_Projects/Spam_Email_Detection/mlruns")